...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    if( $_POST['template-contactform-name'] != '' AND $_POST['template-contactform-email'] != '' AND $_POST['template-contactform-message'] != '' ) {
        ...
        $toemail = 'k.he933@gmail.com'; // Your Email Address
        $toname = 'Kevin'; // Your Name
        ...
        if( $botcheck == '' ) {
            ...
            if( $sendEmail == true ):
                echo 'I have <strong>successfully</strong> received your Message and will get Back to you as soon as possible.';
            else:
